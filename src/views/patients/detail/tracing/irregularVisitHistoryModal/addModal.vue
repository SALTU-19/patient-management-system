...
export default {
    name: "AddIrregularVisitHistoryModal",
    data() {
        return {
            vki: "",
            ewl: "",
    ...
    props: ["showAddIrregularVisitHistoryModal", "patientUID"],
    emits: ["close-modal"],
    watch: {
        showAddIrregularVisitHistoryModal(val) {
            if (val) {
                this.currentStep = 1;
    ...
    methods: {
        ...mapActions(["createIrregularVisitHistory"]),
        ...mapMutations(["setCreateIrregularVisitHistoryCreds"]),
        ...
        controlFields() {
            ...
            if (
                ...
                this.showAddIrregularVisitHistoryModal
            ) {
        ...
        async _createIrregularVisitHistory() {
            this.isSaving = true;




            this.setCreateIrregularVisitHistoryCreds({
            ...
            let response = await this.createIrregularVisitHistory();
        ...
        async finish() {
            ...
            isDone = await this._createIrregularVisitHistory();
...
<template>
    <teleport to="body">
        <Modal title="Add Irregular Visit History" :showModal="showAddIrregularVisitHistoryModal"
                    ...
                    <template v-if="currentStep == 1">
                        <div class="border-b flex flex-col gap-4 border-light p-6">
                            ...
                            <div v-if="patientImages.length > 0">
                                <div class="text-black text-sm font-semibold">Added Images</div>
                                <div class="flex flex-row gap-4">
                                    ...
                                    <div v-for="(image, index) in patientImages" :key="index" class="flex flex-col gap-4">
                                        ...
                                        <img :src="image" alt="Added Image" class="mx-auto"
