...
export default {
    name: "EditIrregularVisitHistoryModal",
    data() {
        return {
            vki: "",
            ewl: "",
    ...
    props: ["showEditIrregularVisitHistoryModal", "selectedIrregularVisitHistory"],
    emits: ["close-modal"],
    watch: {
        showEditIrregularVisitHistoryModal(val) {
            if (val) {
                this.currentStep = 1;
                this.resetForm();
    ...
    methods: {
        ...mapActions(["updateIrregularVisitHistory"]),
        ...mapMutations(["setUpdateIrregularVisitHistoryCreds"]),
        ...
        resetForm() {
            if (this.selectedIrregularVisitHistory != null) {
                this.vki = this.selectedIrregularVisitHistory.vki;
                this.ewl = this.selectedIrregularVisitHistory.ewl;
                this.doctorComment = this.selectedIrregularVisitHistory.doctorComment;
                this.date = this.convertDateFormat(this.selectedIrregularVisitHistory.date);
                // this.bloodSituation = this.selectedIrregularVisitHistory.bloadSituation;
                this.bloodSituation = {
                    base64: this.selectedIrregularVisitHistory.bloadSituation,
                    name: "bloodSituation",
                }
                this.patientImages = this.selectedIrregularVisitHistory.img;
                this.newImage = null;
            }
            else {
                this.vki = "";
        ...
        controlFields() {
            ...
            if (
                ...
                this.showEditIrregularVisitHistoryModal
            ) {
        ...
        async _updateIrregularVisitHistory() {
            this.isSaving = true;




            this.setUpdateIrregularVisitHistoryCreds({
            ...
            let response = await this.updateIrregularVisitHistory({ uid: this.selectedIrregularVisitHistory.uId });
        ...
        async finish() {
            ...
            isDone = await this._updateIrregularVisitHistory();
...
<template>
    <teleport to="body">
        <Modal title="Edit Irregular Visit History" :showModal="showEditIrregularVisitHistoryModal"
