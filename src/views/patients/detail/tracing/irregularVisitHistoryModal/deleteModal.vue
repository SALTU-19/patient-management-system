...
export default {
    name: "DeleteIrregularVisitHistoryModal",
    data() {
        return {
            isSaving: false,
            isError: false,
    ...
    props: ["showDeleteIrregularVisitHistoryModal", "uid"],
    emits: ["close-modal"],
    computed: {

    },
    watch: {
        showDeleteIrregularVisitHistoryModal(val) {
            if (val) {
                this.currentStep = 1;
    ...
    methods: {
        ...mapActions(["deleteIrregularVisitHistory"]),
        ...
        async _deleteIrregularVisitHistory() {
            this.isSaving = true;

            let response = await this.deleteIrregularVisitHistory({ uid: this.uid });
        ...
        async finish() {
            ...
            isDone = await this._deleteIrregularVisitHistory();
    ...
    async mounted() {
        // await this._getAllIrregularVisitHistorys();
        // this.filteredIrregularVisitHistorys = this.hospitals;
        this.resetForm();
    },
...
<template>
    <teleport to="body">
        <Modal title="Delete Irregular Visit History" :showModal="showDeleteIrregularVisitHistoryModal"
