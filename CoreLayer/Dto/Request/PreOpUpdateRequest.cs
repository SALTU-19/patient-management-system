...
{
    public class PreOpUpdateRequest
    {
        public PreOpUpdateRequest() { }

        public PreOpUpdateRequest(int targetWeight, string doctorId, string surgeryType, DateTime surgeryDate, List<string> consultedSurgeryTypes, List<string> supplimentedSurgeryTypes, List<string> assistantDoctors)
        {
